...
function L2DViewMatrix()
{
    ...
    this.min = 0;
    this.defaultScale    = new Float32Array(16);
}
...
//============================================================
//    L2DViewMatrix # saveDefaultScale()
//============================================================
L2DViewMatrix.prototype.saveDefaultScale  = function()
{
    for (var i = 0; i < this.defaultScale.length; i++) {
        this.defaultScale[i] = this.tr[i];
    }
}

//============================================================
//    L2DViewMatrix # setDefaultScale()
//============================================================
L2DViewMatrix.prototype.setDefaultScale     = function()
{
    for (var i = 0; i < this.tr.length; i++) {
        this.tr[i] = this.defaultScale[i];
    }
}
